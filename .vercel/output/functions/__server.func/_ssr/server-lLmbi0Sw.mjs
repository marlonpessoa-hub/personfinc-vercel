...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-B2SWuCM1.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-LiyIfoUb.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B5B117C_.mjs"),
		import("./start-CqypfEl-.mjs"),
